...
public class CR_Garbage extends KineticBlockEntityRenderer<CBE_Garbage> {

    public CR_Garbage(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected void renderSafe(CBE_Garbage blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource buffer, int packedLight, int packedOverlay) {
    ...
    @Override
    public AABB getRenderBoundingBox(CBE_Garbage blockEntity) {
