package com.lanjingzhige.createcobblemon.texture;
...
public class ModIcon implements ScreenElement {

    public static final ResourceLocation ICON_ATLAS = ResourceLocation.fromNamespaceAndPath(CreateCobblemon.MODID,"textures/gui/icons.png");
